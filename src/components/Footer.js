        ...
        <div className="bg-white text-black font-open-sans grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                <ul>
                    ...
                    <li><a className="footer-nav__link" href="https://academicjobs.com/join-aj-talent-pool/">AJ Talent Pool</a></li>
                    <li><a className="footer-nav__link" href="https://academicjobs.com/join-the-a-team/">The A-List</a></li>
                    <li><a href="https://academicjobs.com/join-hr-plus/">HR Plus</a></li>
                    <li><a className="footer-nav__link" href="https://academicjobs.com/login/">Sign in</a></li>
                </ul>
            </div>
            <div>
                <ul>
